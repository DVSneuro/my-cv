...
[*approximate total costs; †approximate direct costs] \\  [.2cm]
% \subsection*{Active}
...
\years{2019-2021} \textbf{Pupillometry as a Physiological Biomarker for Preclinical Dementia in Minority Aging}. (Alzheimer’s Disease Administrative Supplement for NIH R01-DC013063; *\$388,000). Co-Investigator, with PI Reilly. Effort: 11\% (Y1) \\
...
\aiGoogleScholar \hspace{.01cm} \href{https://scholar.google.com/citations?user=czV7OcQAAAAJ&hl=en}{scholar.google.com}: h-index: 19; i10-index: 27; total citations: 1798 \\ 
...
[37] Wang Y*, Metoki A*, \textbf{Smith DV}, Medaglia JD, Zang Y, Benear S, Popal H, Lin Y, Olson IR (2020, in press). Multimodal Mapping of the Face Connectome. \textit{Nature Human Behaviour}. RCR = None.

[36] Ng TH†, Alloy LB, \textbf{Smith DV} (2019). Meta-analysis of Reward Processing in Major Depressive Disorder Reveals Distinct Abnormalities within the Reward Circuit. \textit{Translational Psychiatry}, 9(293). RCR = \py{get_rcr(31712555)} \pdf{https://www.nature.com/articles/s41398-019-0644-x.pdf}
...
Wang S†*, Taren AA*, Tepfer LJ, \textbf{Smith DV}. Functional Parcellation of the Default Mode Network: A Large-Scale Meta-Analysis. Preprint available on \biorxiv{https://www.biorxiv.org/content/10.1101/225375v3}.
...
Botvinik-Nezer R, Holzmeister F, \ldots, Dennison J†, \ldots, \textbf{Smith DV}, \ldots, Schonberg T. Variability in the analysis of a single neuroimaging dataset by many teams. Preprint available on \biorxiv{https://www.biorxiv.org/content/10.1101/843193v1}.
...
Butler PD, Hoptman MJ, Smith DV, Ermel JA, Calderone DC, Lee SH, Barch DM (under review). Grant Report on Social Reward Learning in Schizophrenia. \\
...
\begin{itemize}[noitemsep]
\item \href{https://neurovault.org/collections/3884/}{Ng, Alloy, Smith (2019), \textit{Translational Psychiatry}}
...
\item \faGithub \hspace{.2cm} \href{https://github.com/DVS-Lab/dmn-parcellation}{Wang*, Taren*, Tepfer, \& Smith (under review)} \\
\end{itemize}
...
\> Karen Shen (2019-present), Ph.D. in Psychology (CNS), expected 2024 (co-mentored with Murty) \\
\> Daniel Sazhin (2019-present), Ph.D. in Psychology (CNS), expected 2024 \\
\> Ezgi Kasimoglu (2019-present), Masters in Neuroscience, expected 2020 \\
\> Marissa Chitwood (2019-present), Masters in Neuroscience, expected 2021 (co-mentored with Jarcho) \\ [.2cm]
...
\> Gemma Goldstein, Neuroscience ('20 \textit{LAURA Scholar}). \\
