...
\subsection*{Pending}
\years{2021-2026} \textbf{The influence of mesolimbic-hippocampal interactions on episodic memory during active information seeking}. (NIH R01-DA055259; *\$2,425,000). Co-Investigator, with PI Murty.  \\ [.2cm]
\years{2020-2025} \textbf{Subtyping psychopathology and neural function in the ABCD project}. (NIH R01-MH124786; *\$1,960,000). Co-Investigator, with PI Olino.

\subsection*{Completed}
\years{2018-2021} \textbf{Social Reward Learning in Schizophrenia}. (NIH R21-MH116422; †\$275,000). Consultant, with PI Butler.
...
\aiGoogleScholar \hspace{.01cm} \href{https://scholar.google.com/citations?user=czV7OcQAAAAJ&hl=en}{scholar.google.com}: h-index: 24; i10-index: 33; total citations: 2689 \\ 
