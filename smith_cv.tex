...
\aiGoogleScholar \hspace{.01cm} \href{https://scholar.google.com/citations?user=czV7OcQAAAAJ&hl=en}{scholar.google.com}: h-index: 31; i10-index: 54; total citations: 5889 \\ 
...
Mattoni M†, Wang S†, Sharp CJ†, Olino TM, \textbf{Smith DV}. Precision Imaging for Intraindividual Investigation of the Reward Response. Preprint available on \biorxiv{https://doi.org/10.1101/2025.09.26.678878}.

Yang Y†, Ludwig RM†, Wyngaarden JB†, Dwamena D†, Hackett K, Giovannetti T, Fareri DS, \textbf{Smith DV}. Older Adults Show Altered Network Connectivity during Fairness Decisions with Similar and Dissimilar Partners. Preprint available on \biorxiv{https://doi.org/10.1101/2025.08.13.670194}.

\textbf{Smith DV}, Fareri DS, Dobryakova E. Contributions of default mode network to subjective valuation and maladaptive decision making. Preprint available on \psyarxiv{https://doi.org/10.31234/osf.io/zrd5b_v1}.
...
Dwamena D†*, Stanley JM†*, Wyngaarden JB†, Kos M†, Sharp C†, Jarcho JM, Fareri DS, \textbf{Smith DV}. Neural and Behavioral Responses to Social Norm Violations Across Trust and Fairness Contexts. Preprint available on \biorxiv{https://doi.org/10.1101/2025.11.20.689349}.
...
[72] Wyngaarden JB†*, Nambiar A†*, Dennison J†, Alloy LB, Fareri DS, Jarcho JM, \textbf{Smith DV} (2026, in press). Trait reward sensitivity and behavioral motivation shape connectivity between the default mode network and the striatum during reward anticipation. \textit{Cognitive, Affective, and Behavioral Neuroscience}. Preprint available on \biorxiv{https://doi.org/10.1101/2025.04.17.649386}.

[71] Kilcullen MR, Luistro JN, Kos M, Mennis J, Smith DV, Olson IR (2025). Air pollution and impulsive choice in aging: evidence from delay discounting. \textit{GeroScience}. \doi{https://doi.org/10.1007/s11357-025-01906-0}

[70] Wyngaarden JB†*, Yang Y†*, Dennison JB†*, \textbf{Smith DV}. A dataset of risky and ambiguous decisions using a novel Linked Colored Lottery Task across two studies. \textit{Data Brief}, 61, 111844. \doi{https://doi.org/10.1016/j.dib.2025.111844} \materials{https://github.com/DVS-Lab/risk-ambiguity-DataInBrief} \data{https://doi.org/10.5281/zenodo.15122334}
...
[5]  \textbf{Smith DV}, Lockwood P, Fareri DS (Eds.). (2026, forthcoming). \textit{Neuroeconomics: Core Topics and Current Directions}. Springer Nature.

[4] Wyngaarden J, Giovannetti T, Krekelberg B, \textbf{Smith DV} (2026). Maladaptive decision making in older adults: Confirmation bias and financial exploitation. In D. V. Smith, P. Lockwood, D. S. Fareri (Eds.), \textit{Neuroeconomics: Core Topics and Current Directions}. Springer Nature. Preprint available on \psyarxiv{https://osf.io/preprints/psyarxiv/abnyd}
...
Ad Hoc Reviewer for 103 journals:
\begin{multicols}{2}
...
Society for Neuroeconomics (2025). \\ 
