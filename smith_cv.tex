...
\aiGoogleScholar \hspace{.01cm} \href{https://scholar.google.com/citations?user=czV7OcQAAAAJ&hl=en}{scholar.google.com}: h-index: 28; i10-index: 45; total citations: 4799 \\ 
...
Yang Y, Sazhin D, Wyngaarden III JB, Clithero J, \textbf{Smith DV} (November, 2024). Evidence Accumulation Rate Mediates the Links between Decision Strategy and Decision Maker’s Reward Sensitivity and Trait Emotional Intelligence. Poster to be presented at the Society for Judgment and Decision Making meeting. New York, NY, USA.
