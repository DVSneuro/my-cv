...
Key: * = approximate total costs; † = approximate direct costs
\subsection*{Active}
...
\href{https://scholar.google.com/citations?user=czV7OcQAAAAJ&hl=en}{\aiGoogleScholar \hspace{.01cm} scholar.google.com}: h-index: 16; i10-index: 23; total citations: 1148 \\ 
Key: * = shared first authorship; † = trainee in Smith Lab; RCR = Relative Citation Ratio\footnote{RCR is a field-normalized citation metric that shows the scientific influence of an article relative to the average NIH-funded paper \href{http://journals.plos.org/plosbiology/article?id=10.1371/journal.pbio.1002541}{(Hutchins et al., 2016, \textit{PLoS Biology})}. An RCR > 1 indicates greater influence than the average NIH-funded paper.}
...
\years{1}Almor A, \textbf{Smith DV}, Bonilha L, Fridriksson J, Rorden C (2007). What is in a Name? Spatial Brain Circuits are Used to Track Discourse References. \textit{Neuroreport}, 18(12), 1215-1219. RCR = \py{get_rcr(17632270)} \\
...
\years{1}Clithero JA \& \textbf{Smith DV} (2009). Reference and Preference: How Does the Brain Scale Subjective Value? \textit{Frontiers in Human Neuroscience}, 3:11. RCR = \py{get_rcr(19680434)} \\
...
\years{\aibioRxiv}Wang S*, Taren AA*, \textbf{Smith DV} (under review). Functional Parcellation of the Default Mode Network: A Large-Scale Meta-Analysis. \textit{bioRxiv} \html{https://www.biorxiv.org/content/early/2017/11/27/225375} 
...
\href{https://publons.com/author/1204254/david-v-smith}{\aiPublons \hspace{.05cm} publons.com} contains complete reviewing record. \\ [.2cm]
...
\begin{itemize}[noitemsep]
\item \href{https://github.com/edobryakova/DobryakovaSmith_HCP}{\faGithub \hspace{.2cm} Dobryakova \& Smith (in prep)}
\item \href{https://github.com/DVS-Lab/dmn-parcellation}{\faGithub \hspace{.2cm} Wang*, Taren*, \& Smith (under review)} \\
\end{itemize}
...
\years{2014} Guest Lecturer, The Emotional Brain, Rutgers University. \\
\years{2011} Lab Instructor, Neuroscience Boot Camp, Duke University. \\
\years{2010} Teaching Assistant, Introduction to Cognitive Neuroscience, Duke University. \\
\years{2008} Teaching Assistant, Functional Magnetic Resonance Imaging, Duke University. \\
\years{2008} Teaching Assistant, Brain Waves and Cognition, Duke University. \\
\years{2006} Supplemental Instruction Leader, Psychological Statistics, University of South Carolina. \\
\years{2005-2006} Teaching Assistant, Introductory Psychology, University of South Carolina. \\


% RECENT CONFERENCE PRESENTATIONS
\section*{Recent Conference Presentations}
partial list since 2014 \\
Key: * = shared first authorship; † = trainee in Smith Lab \\
